                ...
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?=$kera->qty?></td>
                      <td id="harga"><?=number_format($kera->harga, 0, ",", ".");?></td>
                      <td>
                      <a href="<?= base_url('pos_umum/delete/' .$kera->id)?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin menghapus data ini')"><i class="fas fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php endforeach ?>
                  </tbody>
        ...
        <div class="card">
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php $no=1; foreach($pos_umum as $pu) : ?>
                  <tr>
                    <td><?=$no++?></td>
                    <td><?=$pu->detail?>-<?=$pu->nama?></td>
                    <td id="harga"><?= "Rp " . number_format($pu->harga, 0, ",", ".");?></td>
                    <td>
                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal<?=$pu->id?>">
...
<div class="modal fade" id="exampleModal<?=$pu->id?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="<?= base_url('pos_umum/tambah_aksi')?>" method="post">
        <div class="form-row">
          <div class="col-5">
            <div class="form-group">
              <label for="">Nama Produk</label>
              <input type="text" name="kode" class="form-control" value="<?= $pu->kode?>" hidden>
              <input type="text" name="nama" class="form-control" value="<?= $pu->detail?>" readonly>
            </div>
          </div>
          <div class="col-3">
            <div class="form-group">
              <label for="">Detail Produk</label>
              <input type="text" name="detail" class="form-control" value="<?= $pu->nama?>" readonly>
            </div>
          </div>
          ...
          <div class="col">
            <div class="form-group">
              ...
              <input type="text" name="harga" class="form-control" value="<?= $pu->harga?>" readonly>
            </div>
          </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?= base_url('pos_umum/belanja')?>" method="post">
        <div class="form-row">
